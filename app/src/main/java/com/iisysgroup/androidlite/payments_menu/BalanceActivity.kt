...
class BalanceActivity : BasePaymentActivity() {
    ...
    internal override fun getPageLayout(): Int {
        return BasePaymentActivity.INT_BALANCE_ENQUIRY
    }
    ...
    fun purchase(amount: Long, accountType : AccountType) {
        ...
        val intent = Intent(this@BalanceActivity, PurchaseProcessor::class.java)
        ...
        if (SharedPreferenceUtils.getIsTerminalPrepped(this)){
            ...
            alert {
                ...
                okButton {
                    startActivity(Intent(this@BalanceActivity, TermMagmActivity::class.java))
        ...
        if (resultCode == Activity.RESULT_CANCELED){
            return
                ...
                if (data != null){
                    ...
                    val intent = Intent(this@BalanceActivity, TransactionCompleteDisplay::class.java)
