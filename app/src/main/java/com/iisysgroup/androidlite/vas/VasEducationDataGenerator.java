...
public class VasEducationDataGenerator {
    public static ArrayList<com.iisysgroup.androidlite.vas.VasItems> generateData(Context context){
        ...
        String[] title = context.getResources().getStringArray(R.array.vas_edu_title);
        String [] image = context.getResources().getStringArray(R.array.vas_edu_image);
