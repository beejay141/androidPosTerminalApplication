...
public class VasGamesGenerator {
    public static ArrayList<VasItems> generateData(Context context){
        ArrayList<VasItems> vasItemsArrayList = new ArrayList<>();

        String[] title = context.getResources().getStringArray(R.array.vas_games_title);
        String [] image = context.getResources().getStringArray(R.array.vas_games_image);
