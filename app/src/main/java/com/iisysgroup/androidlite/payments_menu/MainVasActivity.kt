...
class MainVasActivity : AppCompatActivity() {
            ...
            override fun onCreate(savedInstanceState: Bundle?) {
                ...
                setContentView(R.layout.activity_main_vas)
                launch{
                    SharedPreferenceUtils.setIsTerminalPrepped(this@MainVasActivity, TermMagmActivity.TerminalUtils.isTerminalPrepped(this@MainVasActivity, application as App))
...
//                    0 -> startActivity(Intent(this, PurchaseActivity::class.java))
                    0 -> startActivity(Intent(this, VasActivity::class.java))
                    1 -> {
...
//            6 -> startActivity(Intent(this, CashBack::class.java))
                    4 -> startActivity(Intent(this, WalletBalance::class.java))
...
//        internal var names = arrayOf("Purchase", "VAS", "Transfer", "Withdrawal", "Deposit", "Cash Advance", "Cash back", "Balance Enquiry", "Refund \u0026 Reversal", "Digital Payments")
                ...
                internal var names = arrayOf("VAS", "Transfer", "Withdrawal", "Help", "Balance", "History")

                override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
                    val layoutInflater = LayoutInflater.from(this@MainVasActivity)
...
//                    holder.imageView.setImageResource(R.drawable.ic_digital_payments)
            ...
            override fun onCreateOptionsMenu(menu: Menu): Boolean {
                menuInflater.inflate(R.menu.sub_vas_menu, menu)
            ...
            private fun signOut() {
                ...
                SharedPreferenceUtils.setUserLoggedIn(this@MainVasActivity, false)
